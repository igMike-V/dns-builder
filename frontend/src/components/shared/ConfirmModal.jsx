      ...
      <div className="rounded-lg shadow-lg relative flex flex-col w-full p-1 bg-white">
        ...
        <div className='flex flex-col gap-2 p-9'>
          ...
          <div className='flex gap-2 pb-8'>
            <button className="shadow bg-teal-600 hover:bg-teal-400 focus:shadow-outline focus:outline-none text-white font-bold py-2 px-4 rounded" onClick={proceed}>Yes</button>
            <button className="shadow bg-orange-600 hover:bg-orange-400 focus:shadow-outline focus:outline-none text-white font-bold py-2 px-4 rounded" onClick={cancel}>No</button>
          </div>
          </div>
      </div>
      </div>
